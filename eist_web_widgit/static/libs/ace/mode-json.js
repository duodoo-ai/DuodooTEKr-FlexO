...
define("ace/mode/json_highlight_rules", [
	...
	var JsontHighlightRules = function (options) {
	...
	oop.inherits(JsontHighlightRules, TextHighlightRules);
	function JSX() {
	...
	exports.JsontHighlightRules = JsontHighlightRules;
});
...
define("ace/mode/json", [
	...
	var JsontHighlightRules =
		require("./json_highlight_rules").JsontHighlightRules;
	...
	var Mode = function () {
		this.HighlightRules = JsontHighlightRules;
