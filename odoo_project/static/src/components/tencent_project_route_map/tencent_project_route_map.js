        ...
        this.markers = new TMap.MultiMarker({
            ...
            styles: {
                normal_location_point_marker: new TMap.MarkerStyle({
                    ...
                    height: 18, // 图标高度
                    anchor: { x: 9, y: 9 }, // 图标锚点
                    src: '/odoo_project/static/img/map/tencentmap/green_node_point.png',
                ...
                exception_location_point_marker: new TMap.MarkerStyle({
                    ...
                    height: 18, // 图标高度
                    anchor: { x: 9, y: 9 }, // 图标锚点
                    src: '/odoo_project/static/img/map/tencentmap/red_node_point.png',
                    enableRelativeScale: false, // 是否开启相对缩放
                }),
                normal_location_marker: new TMap.MarkerStyle({
                    ...
                    height: 14, // 图标高度
                    anchor: { x: 7, y: 7 }, // 图标锚点
                    src: '/odoo_project/static/img/map/tencentmap/green_node.png',
                    enableRelativeScale: false, // 是否开启相对缩放
                }),
                exception_location_marker: new TMap.MarkerStyle({
                    ...
                    height: 14, // 图标高度
                    anchor: { x: 7, y: 7 }, // 图标锚点
                    src: '/odoo_project/static/img/map/tencentmap/red_node.png',
                    enableRelativeScale: false, // 是否开启相对缩放
                }),
            },
