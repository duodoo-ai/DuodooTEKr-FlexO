    ...
    setup() {
        ...
        this.markerStyles = {
            ...
            normal_location_point_marker: {
                type: 'image',
                image: '/rtx_project/static/img/map/amap/green_node_point.png',
                size: [24, 24],
                anchor: 'center',
                zIndex: 100,
            },
            ...
            exception_location_point_marker: {
                type: 'image',
                image: '/rtx_project/static/img/map/amap/red_node_point.png',
                size: [24, 24],
                anchor: 'center',
                zIndex: 100,
            },
            ...
            normal_location_dot_marker: {
                type: 'image',
                image: '/rtx_project/static/img/map/amap/green_dots.png',
                size: [16, 16],
                anchor: 'center',
                zIndex: 90,
            },
            ...
            exception_location_dot_marker: {
                type: 'image',
                image: '/rtx_project/static/img/map/amap/red_dots.png',
                size: [16, 16],
                anchor: 'center',
                zIndex: 90,
            },
