...
import { TencentProjectRouteMap } from '@rtx_project/components/tencent_project_route_map/tencent_project_route_map';
import { AmapProjectRouteMap } from '@rtx_project/components/amap_project_route_map/amap_project_route_map';
import { Header } from './components/header/header';
import { Dashboard } from './components/dashboard/dashboard';
import { Overview } from './components/overview/overview';

export class PipelineLargeScreen extends Component {
    static template = 'rtx_project.PipelineLargeScreen';
    static components = {
