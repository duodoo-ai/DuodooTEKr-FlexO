...
export class RouteMapModel extends Model {
     ...
     * 此函数使用 openStreetMap api 将地址转换为坐标。
     * @protected
     * @param {Object} record this object contains the record fetched from the database.
...
RouteMapModel.services = ["notification", "http"];
RouteMapModel.COORDINATE_FETCH_DELAY = 1000;