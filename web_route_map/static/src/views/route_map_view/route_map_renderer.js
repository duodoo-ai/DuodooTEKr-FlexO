...
export class RouteMapRenderer extends Component {
    static template = "web_route_map.RouteMapRenderer";
    static props = {
        model: Object,
    ...
    setup() {
        ...
        this.markers = [];
        this.polylines = [];
        this.routeMapContainerRef = useRef("routeMapContainer");
        this.state = useState({
            closedGroupIds: [],
        ...
        useEffect(
            () => {
                this.leafletMap = L.map(this.routeMapContainerRef.el, {
