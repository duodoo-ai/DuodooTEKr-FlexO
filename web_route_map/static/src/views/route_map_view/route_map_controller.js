...
export class RouteMapController extends Component {
    static template = "web_route_map.RouteMapView";
    static components = {
        Layout,
        SearchBar,
        CogMenu,
    ...
    setup() {
        ...
        onWillStart(() =>
            Promise.all([
                // loadJS("/web_router_map/static/lib/leaflet/leaflet.js"),
                // loadCSS("/web_router_map/static/lib/leaflet/leaflet.css"),
            ])
        );
